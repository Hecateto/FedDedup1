...
class ClientType2:
    ...
    def __init__(self, client_id: int, data_type: EgPsiDataType):
        ...
        self.hash_s = {}  # [明文哈希值 -> 明文]
        self.s_hash = {}  # [明文 -> 明文哈希值]
        ...
        self.ct_pt_hash = {}  # stores ciphertext and corresponding plaintext hash  [密文 -> 明文哈希值]
    ...
    def create_set(self, data_set: List[int]):
        ...
        for ele in self.s:
            ...
            ele_hash = data.hash(ele_bytes) # ele <-> hash(ele)
